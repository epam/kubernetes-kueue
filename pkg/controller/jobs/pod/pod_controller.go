...
// written to the GroupNameAnnotation and any existing GroupNameLabel entry is removed.
// Otherwise, it is written to the GroupNameLabel.
...
func (p *Pod) workloadName() string {
	if prebuiltWorkloadName := jobframework.PrebuiltWorkloadFor(p.Object()); prebuiltWorkloadName != "" {
