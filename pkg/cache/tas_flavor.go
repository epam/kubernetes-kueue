...
func (c *TASFlavorCache) isEqual(other *TASFlavorCache) bool {
	if c == other {
		return true
	}
	if other == nil || c == nil {
	...
	return c.TopologyName == other.TopologyName && slices.Equal(c.Levels, other.Levels) && maps.Equal(c.NodeLabels, other.NodeLabels)
}
