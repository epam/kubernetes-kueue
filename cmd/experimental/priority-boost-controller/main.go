...
import (
	...
	boostconfig "sigs.k8s.io/kueue/cmd/experimental/priority-boost-controller/pkg/config"
	"sigs.k8s.io/kueue/cmd/experimental/priority-boost-controller/pkg/controller"
)
...
func start(configFile string) error {
	...
	reconciler := controller.NewPriorityBoostReconciler(
		mgr.GetClient(),
	...
	if err = reconciler.SetupWithManager(mgr); err != nil {
		log.Error(err, "Unable to create controller", "controller", "PriorityBoost")
		return err
	}
